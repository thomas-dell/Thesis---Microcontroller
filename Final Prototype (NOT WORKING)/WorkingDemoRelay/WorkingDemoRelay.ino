...
void setup()
{
  ...
  BLE.scanForUuid("01BD1279-6A80-43C1-84D4-7E27C59ADE19");
}
...
void loop()
{
  ...
  if (peripheral)
  {
    ...
    Serial.println();
    // PeripheralFlag = 1;
    if (peripheral.localName() != "Sensor_Module")
    {
      return;
    }
...
void AccelReceive(BLEDevice peripheral)
{
  ...
  BLECharacteristic accelCharacteristic = peripheral.characteristic("3E4C2C4F-1D2C-4ABB-98DC-F29052F1AF74");
